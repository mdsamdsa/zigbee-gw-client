...
var STMProto = machina.Fsm.extend({
    ...
    startUpdate: function (ePG) {
        ...
        //noinspection JSPotentiallyInvalidUsageOfThis
        when(this._engines.group_scene.send_get_scene_membership_request(address, ePG.groupId))
            .then(this._engines.group_scene.process_get_scene_membership_cnf)
            .then(this._engines.wait_gateway)
            .then(this._engines.group_scene.process_get_scene_membership_rsp_ind)
            .then(function (msg) {
