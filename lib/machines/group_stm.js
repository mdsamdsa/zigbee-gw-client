...
var STMProto = machina.Fsm.extend({
    ...
    startUpdate: function (endpoint) {
        ...
        //noinspection JSPotentiallyInvalidUsageOfThis
        when(this._engines.group_scene.send_get_group_membership_request(address))
            .then(this._engines.group_scene.process_get_group_membership_cnf)
            .then(this._engines.wait_gateway)
            .then(this._engines.group_scene.process_get_group_membership_rsp_ind)
            .tap(function (msg) {
...
GroupSTMFactory.prototype.create = function(pan, engines, main) {
    ...
    stm.prototype.init = function() {
        this.on_online = function() { this.transition('start'); }.bind(this);
    ...
    stm.prototype.deInit = function() {
        main.removeListener('online', this.on_online);
        main.removeListener('offline', this.on_offline);
