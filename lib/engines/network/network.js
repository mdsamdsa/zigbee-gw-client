...
var factory = function(proxy) {
    ...
    engine.process_nwk_ready_ind = function(msg) {
        if (msg.cmdId != Protocol.NWKMgr.nwkMgrCmdId_t.NWK_ZIGBEE_NWK_READY_IND) {
            var str = 'process_nwk_ready_ind: Expected NWK_ZIGBEE_NWK_READY_IND';
            logger.warn(str);
    ...
    engine.send_nwk_info_request = function() {
    ...
    engine.process_nwk_info_cnf = function(msg) {
