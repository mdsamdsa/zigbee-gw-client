...
var factory = function(proxy) {
    ...
    engine.process_get_neighbor_table_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.NWKMgr.nwkMgrCmdId_t.NWK_GET_NEIGHBOR_TABLE_RSP_IND,
            'NWK_GET_NEIGHBOR_TABLE_RSP_IND',
            'process_get_neighbor_table_rsp_ind',
            logger
        );
    };
    ...
    engine.process_get_routing_table_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.NWKMgr.nwkMgrCmdId_t.NWK_GET_ROUTING_TABLE_RSP_IND,
            'NWK_GET_ROUTING_TABLE_RSP_IND',
            'process_get_routing_table_rsp_ind',
            logger
        );
    };
