...
var factory = function(proxy) {
    ...
    engine.process_attribute_change_ind = function (msg) {
        return Common.process_gateway_custom_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_ATTRIBUTE_CHANGE_IND,
            'GW_ATTRIBUTE_CHANGE_IND',
            'process_attribute_change_ind',
            logger
        );
    };
    ...
    engine.process_get_device_attribute_list_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_GET_DEVICE_ATTRIBUTE_LIST_RSP_IND,
            'GW_GET_DEVICE_ATTRIBUTE_LIST_RSP_IND',
            'process_get_device_attribute_list_rsp_ind',
            logger
        );
    };
    ...
    engine.process_write_device_attribute_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_WRITE_DEVICE_ATTRIBUTE_RSP_IND,
            'GW_WRITE_DEVICE_ATTRIBUTE_RSP_IND',
            'process_write_device_attribute_rsp_ind',
            logger
        );
    };
    ...
    engine.process_set_attribute_reporting_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_SET_ATTRIBUTE_REPORTING_RSP_IND,
            'GW_SET_ATTRIBUTE_REPORTING_RSP_IND',
            'process_set_attribute_reporting_rsp_ind',
            logger
        );
    };
    ...
    engine.process_attribute_reporting_ind = function (msg) {
        return Common.process_gateway_custom_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_ATTRIBUTE_REPORTING_IND,
            'GW_ATTRIBUTE_REPORTING_IND',
            'process_attribute_reporting_ind',
            logger
        );
    };
    ...
    engine.process_zcl_frame_receive_ind = function (msg) {
        return Common.process_gateway_custom_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_ZCL_FRAME_RECEIVE_IND,
            'GW_ZCL_FRAME_RECEIVE_IND',
            'process_zcl_frame_receive_ind',
            logger
        );
    };
