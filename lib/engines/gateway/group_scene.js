...
var factory = function(proxy) {
    ...
    engine.process_get_group_membership_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_GET_GROUP_MEMBERSHIP_RSP_IND,
            'GW_GET_GROUP_MEMBERSHIP_RSP_IND',
            'process_get_group_membership_rsp_ind',
            logger
        );
    };
    ...
    engine.process_get_scene_membership_rsp_ind = function (msg) {
        return Common.process_gateway_custom_rsp_ind(
            msg,
            Protocol.GatewayMgr.gwCmdId_t.GW_GET_SCENE_MEMBERSHIP_RSP_IND,
            'GW_GET_SCENE_MEMBERSHIP_RSP_IND',
            'process_get_scene_membership_rsp_ind',
            logger
        );
    };
