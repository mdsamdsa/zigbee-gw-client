...
group_scene.send_store_scene_request = function(address, groupId, sceneId) {
...
group_scene.process_store_scene_cnf = function(msg) {
    return Common.process_gateway_generic_cnf(msg, 'process_store_scene_cnf', logger);
};

group_scene.process_store_scene_rsp_ind = function(msg) {
    return Common.process_gateway_generic_rsp_ind(msg, 'process_store_scene_rsp_ind', logger);
};

group_scene.send_remove_scene_request = function(address, groupId, sceneId) {
...
group_scene.process_remove_scene_cnf = function(msg) {
    return Common.process_gateway_generic_cnf(msg, 'process_remove_scene_cnf', logger);
};

group_scene.process_remove_scene_rsp_ind = function(msg) {
...
group_scene.process_recall_scene_cnf = function(msg) {
    return Common.process_gateway_generic_cnf(msg, 'process_recall_scene_cnf', logger);
};

group_scene.process_recall_scene_rsp_ind = function(msg) {
