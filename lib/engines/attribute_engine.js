...
attribute.process_read_device_attribute_rsp_ind = function(msg) {
    ...
    if (msg.status == Protocol.GatewayMgr.gwStatus_t.STATUS_SUCCESS || (msg.status == Protocol.GatewayMgr.gwStatus_t.STATUS_FAILURE && typeof msg.attributeRecordList != 'undefined' && msg.attributeRecordList.length > 0)) {
