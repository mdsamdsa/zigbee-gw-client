...
/*        var endpoint = attribute.pan.getEndpoint(msg.srcAddress);
...
attribute.send_write_device_attribute_request = function(address, clusterId, attributeRecordList) {
...
attribute.process_write_device_attribute_cnf = function(msg) {
    return Common.process_gateway_generic_cnf(msg, 'process_write_device_attribute_cnf', logger);
};

attribute.process_write_device_attribute_rsp_ind = function(msg) {
...
/*        var endpoint = attribute.pan.getEndpoint(msg.srcAddress);
        if (typeof endpoint == 'undefined') {
            logger.info('process_write_device_attribute_rsp_ind: endpoint not found');
        } else {
            //TODO Update attribute value
        }*/
    }
...
attribute.process_set_attribute_reporting_cnf = function(msg) {
    return Common.process_gateway_generic_cnf(msg, 'process_set_attribute_reporting_cnf', logger);
};

attribute.process_set_attribute_reporting_rsp_ind = function(msg) {
...
/*        var endpoint = attribute.pan.getEndpoint(msg.srcAddress);
        if (typeof endpoint == 'undefined') {
            logger.info('process_set_attribute_reporting_rsp_ind: endpoint not found');
        } else {
            //TODO Update attribute value
        }*/
    }
...
attribute.process_attribute_reporting_ind = function(msg) {
    if (msg.cmdId != Protocol.GatewayMgr.gwCmdId_t.GW_ATTRIBUTE_REPORTING_IND) {
        logger.warn('process_attribute_reporting_ind: Expected GW_ATTRIBUTE_REPORTING_IND');
        return false;
    }
