...
Profiles.on('ready', function() {
    ...
    function sequence(arr, arg1, arg2) {
    ...
    function test_group_scene() {
        ...
        sequence([
            function(address, groupId) {
                when(engines.group_scene.send_add_group_request(address, groupId, ''))
            ...
            function(address, groupId) {
                when(engines.group_scene.send_remove_from_group_request(address, groupId))
